...
namespace Celeste
{
  public class _3dSoundTest : Entity
  {
    ...
    {
      Draw.Rect(this.X - 8f, this.Y - 8f, 16f, 16f, Color.get_Yellow());
      Camera camera = (this.Scene as Level).Camera;
      Draw.HollowRect(this.X - 320f, camera.Y, 640f, 180f, Color.get_Red());
      Draw.HollowRect(this.X - 160f, camera.Y, 320f, 180f, Color.get_Yellow());
      Draw.HollowRect((float) ((double) this.X - 160.0 - 320.0), camera.Y, 960f, 180f, Color.get_Yellow());
    }
  }
}
