...
namespace Celeste
{
  public class KeyDoorWipe : ScreenWipe
  {
    ...
    public override void Render(Scene scene)
    {
      ...
      float num12 = (float) num2 + (float) num2 * 0.5f * num5 * num7;
      float angleRadians1 = 0.0f;
      int num13 = 0;
      VertexPositionColor[] vertex1 = this.vertex;
      int index1 = num13;
      int num14 = index1 + 1;
      vertex1[index1].Position = (__Null) new Vector3(-10f, -10f, 0.0f);
      VertexPositionColor[] vertex2 = this.vertex;
      int index2 = num14;
      int num15 = index2 + 1;
      vertex2[index2].Position = (__Null) new Vector3(num8, -10f, 0.0f);
      VertexPositionColor[] vertex3 = this.vertex;
      int index3 = num15;
      int num16 = index3 + 1;
      vertex3[index3].Position = (__Null) new Vector3(num8, num11 - num10, 0.0f);
      for (int index4 = 1; index4 <= 8; ++index4)
      {
        ...
        int index5 = num16;
        int num17 = index5 + 1;
        vertex4[index5].Position = (__Null) new Vector3(-10f, -10f, 0.0f);
        VertexPositionColor[] vertex5 = this.vertex;
        int index6 = num17;
        int num18 = index6 + 1;
        vertex5[index6].Position = (__Null) new Vector3(Vector2.op_Addition(new Vector2(num8, num11), Vector2.op_Multiply(Calc.AngleToVector(angleRadians2, 1f), new Vector2(num9, num10))), 0.0f);
        VertexPositionColor[] vertex6 = this.vertex;
        int index7 = num18;
        num16 = index7 + 1;
        vertex6[index7].Position = (__Null) new Vector3(Vector2.op_Addition(new Vector2(num8, num11), Vector2.op_Multiply(Calc.AngleToVector(angleRadians1, 1f), new Vector2(num9, num10))), 0.0f);
      }
      VertexPositionColor[] vertex7 = this.vertex;
      int index8 = num16;
      int num19 = index8 + 1;
      vertex7[index8].Position = (__Null) new Vector3(-10f, -10f, 0.0f);
      VertexPositionColor[] vertex8 = this.vertex;
      int index9 = num19;
      int num20 = index9 + 1;
      vertex8[index9].Position = (__Null) new Vector3(num8 - num9, num11, 0.0f);
      VertexPositionColor[] vertex9 = this.vertex;
      int index10 = num20;
      int num21 = index10 + 1;
      vertex9[index10].Position = (__Null) new Vector3(-10f, (float) num1, 0.0f);
      for (int index4 = 1; index4 <= 6; ++index4)
      {
        ...
        int index5 = num21;
        int num17 = index5 + 1;
        vertex4[index5].Position = (__Null) new Vector3(-10f, (float) num1, 0.0f);
        VertexPositionColor[] vertex5 = this.vertex;
        int index6 = num17;
        int num18 = index6 + 1;
        vertex5[index6].Position = (__Null) new Vector3(Vector2.op_Addition(new Vector2(num8, num11), Vector2.op_Multiply(Calc.AngleToVector(angleRadians2, 1f), new Vector2(num9, num10))), 0.0f);
      ...
      int index11 = num21;
      int num22 = index11 + 1;
      vertex10[index11].Position = (__Null) new Vector3(-10f, (float) num1, 0.0f);
      VertexPositionColor[] vertex11 = this.vertex;
      int index12 = num22;
      int num23 = index12 + 1;
      vertex11[index12].Position = (__Null) new Vector3(Vector2.op_Addition(new Vector2(num8, num11), Vector2.op_Multiply(Calc.AngleToVector(angleRadians1, 1f), new Vector2(num9, num10))), 0.0f);
      VertexPositionColor[] vertex12 = this.vertex;
      int index13 = num23;
      int num24 = index13 + 1;
      vertex12[index13].Position = (__Null) new Vector3(num8 - num9 * 0.8f, num12, 0.0f);
      VertexPositionColor[] vertex13 = this.vertex;
      int index14 = num24;
      int num25 = index14 + 1;
      vertex13[index14].Position = (__Null) new Vector3(-10f, (float) num1, 0.0f);
      VertexPositionColor[] vertex14 = this.vertex;
      int index15 = num25;
      int num26 = index15 + 1;
      vertex14[index15].Position = (__Null) new Vector3(num8 - num9 * 0.8f, num12, 0.0f);
      VertexPositionColor[] vertex15 = this.vertex;
      int index16 = num26;
      int num27 = index16 + 1;
      vertex15[index16].Position = (__Null) new Vector3(num8, num12, 0.0f);
      VertexPositionColor[] vertex16 = this.vertex;
      int index17 = num27;
      int num28 = index17 + 1;
      vertex16[index17].Position = (__Null) new Vector3(-10f, (float) num1, 0.0f);
      VertexPositionColor[] vertex17 = this.vertex;
      int index18 = num28;
      int num29 = index18 + 1;
      vertex17[index18].Position = (__Null) new Vector3(num8, num12, 0.0f);
      VertexPositionColor[] vertex18 = this.vertex;
      int index19 = num29;
      int num30 = index19 + 1;
      vertex18[index19].Position = (__Null) new Vector3(num8, (float) num1, 0.0f);
      ...
      for (int index4 = 0; index4 < this.vertex.Length; ++index4)
      {
        ...
        // ISSUE: cast to a reference type
        // ISSUE: explicit reference operation
        (^(Vector3&) ref this.vertex[index4].Position).X = (__Null) (1920.0 - (^(Vector3&) ref this.vertex[index4].Position).X);
      }
      ScreenWipe.DrawPrimitives(this.vertex);
    }
  }
