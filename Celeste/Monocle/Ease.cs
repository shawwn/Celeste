  ...
  public static class Ease
  {
    ...
    public static readonly Ease.Easer BounceIn = (Ease.Easer) (t =>
    {
      ...
      if ((double) t < 0.909090936183929)
        return (float) (1.0 - (121.0 / 16.0 * ((double) t - 0.818181812763214) * ((double) t - 0.818181812763214) + 15.0 / 16.0));
      return (float) (1.0 - (121.0 / 16.0 * ((double) t - 0.954545438289642) * ((double) t - 0.954545438289642) + 63.0 / 64.0));
    });
    public static readonly Ease.Easer BounceOut = (Ease.Easer) (t =>
    {
      ...
      if ((double) t < 0.909090936183929)
        return (float) (121.0 / 16.0 * ((double) t - 0.818181812763214) * ((double) t - 0.818181812763214) + 15.0 / 16.0);
      return (float) (121.0 / 16.0 * ((double) t - 0.954545438289642) * ((double) t - 0.954545438289642) + 63.0 / 64.0);
    });
    public static readonly Ease.Easer BounceInOut = (Ease.Easer) (t =>
    {
      if ((double) t < 0.5)
      {
        ...
        if ((double) t < 0.909090936183929)
          return (float) ((1.0 - (121.0 / 16.0 * ((double) t - 0.818181812763214) * ((double) t - 0.818181812763214) + 15.0 / 16.0)) / 2.0);
        return (float) ((1.0 - (121.0 / 16.0 * ((double) t - 0.954545438289642) * ((double) t - 0.954545438289642) + 63.0 / 64.0)) / 2.0);
      }
      ...
      if ((double) t < 0.909090936183929)
        return (float) ((121.0 / 16.0 * ((double) t - 0.818181812763214) * ((double) t - 0.818181812763214) + 15.0 / 16.0) / 2.0 + 0.5);
      return (float) ((121.0 / 16.0 * ((double) t - 0.954545438289642) * ((double) t - 0.954545438289642) + 63.0 / 64.0) / 2.0 + 0.5);
    });
    ...
    public static Ease.Easer Follow(Ease.Easer first, Ease.Easer second)
    {
      ...
      {
        if ((double) t > 0.5)
          return (float) ((double) second((float) ((double) t * 2.0 - 1.0)) / 2.0 + 0.5);
    ...
    public static float UpDown(float eased)
    {
      if ((double) eased <= 0.5)
        return eased * 2f;
      return (float) (1.0 - ((double) eased - 0.5) * 2.0);
    }
